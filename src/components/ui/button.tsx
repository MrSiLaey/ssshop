...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default:
          'bg-gradient-to-r from-yellow-400 to-yellow-500 text-black font-semibold hover:from-yellow-300 hover:to-yellow-400 shadow-lg shadow-yellow-500/25 hover:shadow-yellow-500/40',
        destructive:
          'bg-zinc-800 text-zinc-300 hover:bg-zinc-700 border border-zinc-600',
        outline:
          'border-2 border-yellow-500/50 bg-transparent text-yellow-400 hover:bg-yellow-500/10 hover:border-yellow-400',
        secondary:
          'bg-zinc-900 text-zinc-100 hover:bg-zinc-800 border border-zinc-700',
        ghost:
          'text-zinc-300 hover:text-white hover:bg-white/5',
        link:
          'text-yellow-400 underline-offset-4 hover:underline hover:text-yellow-300',
        neon:
          'bg-transparent border-2 border-yellow-500 text-yellow-400 hover:bg-yellow-500/10 hover:shadow-lg hover:shadow-yellow-500/20',
        glow:
